...
import RegressionSuite.ECommerce_TestNG.PageObjects.LoginPage;
import RegressionSuite.ECommerce_TestNG.PageObjects.OrdersPage;
import RegressionSuite.ECommerce_TestNG.PageObjects.ProductCatalogue;
...
//	create a properties class, that decides on runtime which browser to used for executing test cases
	...
	public static LoginPage loginApp;
...
//		convert file into stream
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+
				"//src//main//java//RegressionSuite//ECommerce_TestNG//Resources//GlobalData.properties");
